...
import { ReviewDetailsType } from "../../../../services/admin.service";
...
import DescriptionCard from "../../../Ads/AdDetails/DescriptionCard";
import { FaThList, FaTag, FaUserTag, FaLeaf } from "react-icons/fa";

import { BiSolidBandAid } from "react-icons/bi";

const AdDetails: FunctionComponent<ReviewDetailsType> = (ad) => {
